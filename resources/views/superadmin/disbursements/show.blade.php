...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        {{-- Tombol Cetak PDF --}}
        <a href="{{ route('superadmin.disbursements.pdf', $disbursement->id) }}" target="_blank" class="btn btn-danger">
    ...
    <div class="card">
        ...
        <div class="card-footer">
            <a href="{{ route('superadmin.disbursements.index') }}" class="btn btn-secondary">
