            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('pengelola.profile.avatar') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="formAccountSettings" method="POST" action="{{ route('pengelola.profile.password') }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                ...
                <div class="col-md-7">
                     <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form id="formAccountDetails" method="POST" action="{{ route('pengelola.profile.update') }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
