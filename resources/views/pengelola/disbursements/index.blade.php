    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
            ...
            <div class="d-flex align-items-center gap-3">
                {{-- Form Pencarian --}}
                <form action="{{ route('pengelola.disbursements.index') }}" method="GET" class="d-flex">
                ...
                <a href="{{ route('pengelola.disbursements.create') }}" class="btn btn-primary text-nowrap">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                             <a href="{{ route('pengelola.disbursements.show', $d->id) }}" class="btn btn-icon btn-sm btn-info" title="Detail"><i class="bx bx-show"></i></a>
                             <a href="{{ route('pengelola.disbursements.edit', $d->id) }}" class="btn btn-icon btn-sm btn-warning" title="Edit"><i class="bx bx-edit"></i></a>
