...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <form action="{{ route('pengelola.disbursements.update', $disbursement->id) }}" method="POST" id="disbursementForm" enctype="multipart/form-data">
        @csrf
        @method('PUT')
    ...
    @endif
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('pengelola.disbursements.index') }}" class="btn btn-secondary">Batal</a>
                        </div>
                    </div>
                </div>
            </div>
