...
class DisbursementController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('pengelola.disbursements.create', compact('classes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pengelola.disbursements.index')->with('success', 'Penyaluran dana berhasil dicatat.');
    }
    ...
    public function edit(SDisbursement $disbursement)
    {
        ...
        $classes = $this->getClassesWithBalance();
        return view('pengelola.disbursements.edit', compact('disbursement', 'classes'));
    }
    ...
    public function update(Request $request, SDisbursement $disbursement)
    {
        ...
        return redirect()->route('pengelola.disbursements.index')->with('success', 'Penyaluran dana berhasil diperbarui.');
    }
    ...
    public function destroy(SDisbursement $disbursement)
    {
        ...
        return redirect()->route('pengelola.disbursements.index')->with('success', 'Penyaluran dibatalkan. Dana telah dikembalikan ke saldo kelas.');
    }

    public function show(SDisbursement $disbursement)
    {
        $disbursement->load('allocations.classRoom');
        return view('pengelola.disbursements.show', compact('disbursement'));
    }
    ...
    public function downloadPDF(SDisbursement $disbursement)
    {
        ...
        // Load View PDF
        $pdf = Pdf::loadView('pengelola.disbursements.pdf', compact('disbursement'));
